...
1. **Wie is de eigenaar?** Eén naam (categorymanagement of pricing), niet "het MT". De eigenaar agendeert het maandagoverleg en bewaakt de actieteller. Zonder eigenaar geen tool.
...
3. **Welke 30 artikelen bepalen ons ondergoed-prijsimago?** De klant kent geen honderden prijzen, maar wel de boxers 3-pack, dameshipsters multipack, kindersokken 5-pack, basis-bh en de flanellen pyjama. Maak die **KVI-lijst** (key value items) en koppel per KVI handmatig het vergelijkbare artikel per concurrent. Dit is de enige plek waar handwerk loont — één middag werk, blijvend rendement. (De datastructuur ondersteunt dit; zie roadmap fase 2.)
