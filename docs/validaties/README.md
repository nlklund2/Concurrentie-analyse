...
zijn alleen wat waard als een ander ze kan narekenen. Een externe review
...
| 18-08-2026 | `2026-08-18-zeeman-eindoordeel.md` | Zeeman rood: uitgeklede serving op elke laag |
| 19-08-2026 | `2026-08-19-zeeman-paginering.md` | `?page=`-route (externe suggestie) gemeten en verworpen |
